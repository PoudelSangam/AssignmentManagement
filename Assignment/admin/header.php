            ...
            <div class="max-w-7xl mx-auto px-4 py-3">
                <div class=" flex justify-between items-center">
                    ...
                    <a href="#" class="flex items-center">
                        <img src="https://poudelsangam.com.np/download.png" id="profile-picture" alt="Profile Picture" class="rounded-full h-8 w-8 mr-2">
    ...
    <div id="mySidebar" class="sidebar fixed top-0 left-0 w-64 h-screen bg-gray-800 text-white transform -translate-x-full md:translate-x-0 md:visible transition-transform duration-500 md:block z-50">
        <div class="px-4 py-6">
            <div class="text-center">
                <img src="https://poudelsangam.com.np/download.png" alt="Profile Picture" class="rounded-full h-20 w-20 mx-auto mb-2">
